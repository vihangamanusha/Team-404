...
public class LectuerEdit {
    ...
    public LectuerEdit() {
        ...
        button1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new LectureDashboard(); // Navigate back to the lecturer's dashboard
    ...
    private void loadCurrentProfile() {
        try (Connection conn = DBConnection.getConnection()) {
            ...
            pstmt.setString(1, UserSession.getInstance().getUsername()); // Get the logged-in user's username
    ...
    private void updateProfile() {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            String sql = "UPDATE USER SET First_Name = ?, Last_Name = ?, Phone_Number = ?, Email = ?, Profile_Pic_Path = ? WHERE Username = ? AND Role = 'Lecturer'";
            PreparedStatement pstmt = conn.prepareStatement(sql);
            ...
            pstmt.setString(6, UserSession.getInstance().getUsername()); // Update based on logged-in user
            ...
            if (rowsUpdated > 0) {
                ...
                JOptionPane.showMessageDialog(frame, "Update failed. Ensure you're logged in as a Lecturer.");
            }
    ...
    public static void main(String[] args) {
        ...
        UserSession.getInstance().setUsername("testUsername"); // Set the username for testing
