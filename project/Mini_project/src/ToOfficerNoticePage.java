...
public class ToOfficerNoticePage {
    ...
    public ToOfficerNoticePage() {
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                frame.dispose();
                // Add logic to go back to the previous page (e.g., Officer Dashboard)
                // For example: new OfficerDashboard();
            }
        });
    ...
    private void loadNoticeData() {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            // Updated query to select all notices (no filter by category)
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ToOfficerNoticePage(); // Create and display the ToOfficerNoticePage
            }
        });
    }
}
